const contractAddress = "0xE7D64C883A40F4F073C9d5eCD5F73e31202B677F"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Land of Big Ted!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'In a far away land, the one true Big Ted appeared. He now has 4096 sons and daughters. Although all are unique, he has his favourites...';
const h1_presale_coming_soon = "NFT Drop Coming Soon!!";
const h1_presale_mint = "Pre-Sale Minting Open!!";
const h1_public_mint = "The Sons and Daughters of Big Ted";
...
const p_public_mint = "In a far away land, the one true Big Ted appeared. He now has 4096 sons and daughters. Although all are unique, he has his favourites...";
